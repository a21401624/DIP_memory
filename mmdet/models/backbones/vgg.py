# Date: 2022/10/21
# Modified: 2022/12/14
# Copied from the new version of mmcls.
...
def make_vgg_layer(in_channels,
    ...
    for i in range(num_blocks):
        if not with_last_act and i == num_blocks -1:
            act_cfg=None
        layer = ConvModule(
...
class VGG(BaseModule):
    ...
    Args:
        ...
        with_last_act (bool): Whether to keep the last activation function 
            if the backbone. Default: True.
    """
